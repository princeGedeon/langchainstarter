...
def lookup(name:str):
    ...
    tools_for_agent=[Tool(name="Explorer Google pour troiver les page profil Linnkedin",func=get_profile_url,
                          description="Utile quand tu as besoin de trouver des page profil Linkedin")]
