...
def  prince_break(name:str)-> Tuple[Person,str]:
    """
    ...
    summary_template = """
        Étant donné  {information} sur une personne que je veux que vous me donnez tout en français:
        1. Un court résumé
    ...
    print(res)
    return person_parser.parse(res),linkedin_data.get("profile_pic_url")
